(function() {
  ...
  function FabController($scope, $element, $animate, $mdUtil) {
    var vm = this;
    ...
    function disableKeyboard() {
      ...
      $mdUtil.enableScrolling($element);
    }

    function keyPressed(event) {
      switch (event.which) {
        // SPACE (prevent accidental scrolling)
        case 32: event.preventDefault(); return false;
        // LEFT
        case 37: doKeyLeft(event); return false;
        // UP
        case 38: doKeyUp(event); return false;
        // RIGHT
        case 39: doKeyRight(event); return false;
        // DOWN
        case 40: doKeyDown(event); return false;
      }
    }
